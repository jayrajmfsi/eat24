...
final class ErrorConstants
{
    ...
    public static $errorCodeMap = [
        ...
        self::PHONE_NUMBER_EXISTS => ['code' => '409', 'message' => 'api.response.error.phone_number_exists'],
        ...
        self::USERNAME_EXISTS => ['code' => '409', 'message' => 'api.response.error.username_exists'],
        self::EMAIL_EXISTS => ['code' => '409', 'message' => 'api.response.error.email_exists'],
